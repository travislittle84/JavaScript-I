...
console.log(`Last car on lot: ${inventory[lastCar].car_make} ${inventory[lastCar].car_model}`);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
let carModels = inventory.sort(function(a,b){return a.car_model > b.car_model});
...
console.log(`JSON: ${JSON.stringify(BMWAndAudi)}`);
